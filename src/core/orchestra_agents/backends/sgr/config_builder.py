...
from core.orchestra_agents.backends.sgr import value_normalization as _value_norm
...
def build_settings(raw: dict[str, Any]) -> _support.SGRRuntimeSettings:
    ...
    return _support.SGRRuntimeSettings(
        react_to_inactive=_normalize_bool(raw.get("react_to_inactive"), default=True),
