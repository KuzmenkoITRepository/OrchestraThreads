...
from core.orchestra_agents.backends.opencode import backend_registration as _registration
from core.orchestra_agents.backends.sgr import backend_components as _components
...
class SGRMinimaxBackend(_rt.BaseAgentBackend):
    ...
    def __init__(  # noqa: WPS211 — extends parent's 4-arg constructor
        ...
        *,
        ...
        from core.orchestra_agents.backends.sgr import config_builder as _cfg
    ...
    async def handle_events(
        ...
        *,
        ...
        async with self._turn_lock:
            from core.orchestra_agents.backends.sgr import event_routing as _routing
...
def configure_mcp_tools(
    ...
    from core.orchestra_agents.backends.sgr import tool_definitions as _tool_defs
