"""Internal LLM client implementation for the canonical SGR backend."""
...
class _ReplySanitizer(Protocol):
    def __call__(self, text: str) -> str: ...


class SGRLLMClientCore:
    def __init__(
        self,
        agent_slug: str,
        route_policy: str,
        ...
        *,
        sanitize_reply_text: _ReplySanitizer,
    ) -> None:
        self._agent_slug = agent_slug
        self._route_policy = route_policy
        self._timeout_seconds = timeout_seconds
        self._sanitize_reply_text = sanitize_reply_text
    ...
    async def chat_completion(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        if _routing.requires_streaming_chat(_payload_model(request_payload)):
