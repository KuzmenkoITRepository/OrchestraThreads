...
from core.orchestra_agents.templates.opencode.agent_runtime.backend_state import (
    Components,
    RuntimePaths,
)
...
async def start_components(params: ComponentParams) -> Components:
    from core.orchestra_agents.templates.opencode.agent_runtime.event_dispatch import (
        EventDispatcher,
    )
    ...
    from core.orchestra_agents.templates.opencode.agent_runtime.opencode_process import (
        OpencodeProcess,
    )
    from core.orchestra_agents.templates.opencode.agent_runtime.session_manager import (
        SessionManager,
    )
